...
const AdminLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result?.success) {
      navigate('/Wedding-Invitation/Admin/dashboard');
    }
  };
      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.85rem' }}>
            Ideación 360 — Wedding Invitations
          </p>
        </div>
          ...
          {error && (
            <motion.div
              ...
              style={{
                ...
                borderRadius: 8, padding: '0.75rem 1rem', marginBottom: '1.5rem', color: '#f87171', fontSize: '0.85rem',
              }}
            >
              <AlertCircle size={16} />
              {error}
        ...
        <div style={{
          ...
          background: 'rgba(138,196,224,0.08)', border: '1px solid rgba(138,196,224,0.15)',
          textAlign: 'center',
        }}>
