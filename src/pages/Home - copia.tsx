        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <motion.h1
                ...
                style={{ fontSize: 'clamp(3rem, 6vw, 5.5rem)', marginBottom: '1rem', lineHeight: 1.05, fontWeight: 900, letterSpacing: '-0.04em' }}
              >
                <span style={{ color: '#FFFFFF' }}>Ideación</span>{' '}
                <span style={{ 
              ...
              >
                <h2 style={{ fontSize: 'clamp(1.5rem, 2.5vw, 2.2rem)', fontWeight: 500, lineHeight: 1.3 }}>
                  Transformamos ideas en soluciones<br />
                  <span style={{ 
                    fontWeight: 700,
                    background: 'linear-gradient(to right, #8b5cf6, #D7B272)', 
                    WebkitBackgroundClip: 'text', 
                    WebkitTextFillColor: 'transparent', 
                    backgroundClip: 'text' 
                  }}>digitales memorables</span>
                </h2>
              </motion.div>
              ...
              >
                <Link to="/wedding" style={{ textDecoration: 'none' }}>
                  <button style={{
                    ...
                    background: 'linear-gradient(to right, #8b5cf6, #D7B272)', border: 'none', borderRadius: '30px',
                ...
                {[
                  {
                    icon: Globe,
                    title: 'Sitios Web',
                    desc: 'Modernos, rápidos y responsivos.',
                    color: '#3b82f6',
                  ...
                  },
                  {
                    ...
                    desc: 'Personalizadas y llenas de estilo.',
                    color: '#8b5cf6',
                    gradient: 'linear-gradient(135deg, rgba(139, 92, 246, 0.12) 0%, rgba(215, 178, 114, 0.08) 100%)'
                  },
                  {
                    icon: Play,
                    title: 'Animación Digital',
                    ...
                    color: '#D7B272',
                    gradient: 'linear-gradient(135deg, rgba(215, 178, 114, 0.12) 0%, rgba(59, 130, 246, 0.08) 100%)'
                  }
                ].map((card, i) => (
                  <motion.div
                    key={i}
          ...
          <style>{`
            @media (max-width: 768px) {
              ...
              .hero-grid .hero-ctas, .hero-grid .hero-cards {
                justify-content: center !important;
              }
            }
          `}</style>
      ...
      <section style={{ padding: '4rem 0', background: '#090721', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        <div className="container">
          <motion.div
            ...
            viewport={{ once: true }}
            style={{
              display: 'flex', justifyContent: 'center', gap: 'clamp(2rem, 8vw, 6rem)',
              flexWrap: 'wrap',
            }}
          >
            {stats.map(({ value, label, icon: Icon }) => (
              <div key={label} style={{ textAlign: 'center', minWidth: '150px' }}>
                ...
                <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.9rem', fontWeight: 500 }}>{label}</div>
              </div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="section">
        <div className="container">
          ...
          >
            ...
            <h2 style={{ fontSize: 'clamp(2.2rem, 4vw, 3.8rem)', marginBottom: '1rem' }}>
