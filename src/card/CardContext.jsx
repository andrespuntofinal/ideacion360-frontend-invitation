...
// ─── Provider ─────────────────────────────────────────────────────────────────
export function CardProvider({ eventId, children }) {
    ...
    useEffect(() => {
        ...
        eventsService.getById(eventId)
            .then(({ data }) => {
                ...
                // Deep merge: fallback values first, then override with DB values
                ...
                setConfig({
                    ...DEFAULT_CONFIG,
                    paramsGeneral: {
                        ...DEFAULT_CONFIG.paramsGeneral,
                        weddingDate: wedding.weddingDate ? new Date(wedding.weddingDate).toISOString() : DEFAULT_CONFIG.paramsGeneral.weddingDate,
                        coupleNames: wedding.coupleNames || DEFAULT_CONFIG.paramsGeneral.coupleNames,
                        guestName: DEFAULT_CONFIG.paramsGeneral.guestName,
                        numberGuests: DEFAULT_CONFIG.paramsGeneral.numberGuests,
                    },
                    ...
                    message: {
                        ...
                        // fix field name mismatch: DB uses backgroundColor, card uses backgroundcolor
                        backgroundColor: comps.message?.backgroundColor || DEFAULT_CONFIG.message.backgroundColor,
                    },
                    ...
                    eventDetails: {
                        ...
                        ceremony: merge(DEFAULT_CONFIG.eventDetails.ceremony, comps.eventDetails?.ceremony),
                        celebration: merge(DEFAULT_CONFIG.eventDetails.celebration, comps.eventDetails?.celebration),
                    },
                    ...
                    rsvp: {
                        ...
                        buttonYes1Style: merge(DEFAULT_CONFIG.rsvp.buttonYes1Style, comps.rsvp?.buttonYes1Style),
                        buttonYes2Style: merge(DEFAULT_CONFIG.rsvp.buttonYes2Style, comps.rsvp?.buttonYes2Style),
                        buttonNot1Style: merge(DEFAULT_CONFIG.rsvp.buttonNot1Style, comps.rsvp?.buttonNot1Style),
                        buttonNot2Style: merge(DEFAULT_CONFIG.rsvp.buttonNot2Style, comps.rsvp?.buttonNot2Style),
                        buttonSendStyle: merge(DEFAULT_CONFIG.rsvp.buttonSendStyle, comps.rsvp?.buttonSendStyle),
                        textareaStyle: merge(DEFAULT_CONFIG.rsvp.textareaStyle, comps.rsvp?.textareaStyle),
                    },
                });
                setActiveComponents({
                    ...DEFAULT_CONFIG.activeComponents,
                    ...active,
                });
                setLoading(false);
            })
