...
export default function EventDetails() {
  ...
  return (
    <section className="w-full py-6 md:py-10 px-0 md:px-4">
      ...
      >
        <p className="text-2xl md:text-3xl italic font-bold" style={{ color: eventDetails.detailsColor, fontFamily: eventDetails.detailsFont }}>
          𓆸 &nbsp; {eventDetails.detailsTitle} &nbsp; 𓆸
        </p>
        <br />
        <br />
        ...
        {details.map((item, i) => (
          ...
          >
            <div className="w-full px-2 sm:px-6 pt-16 pb-6 flex flex-col items-center flex-1">
              ...
              {/* Title */}
              <h3
                className="text-base sm:text-2xl italic leading-relaxed mb-2 font-bold"
              ...
              <div className="space-y-3 w-full mb-6">
                ...
                >
                  ...
                  <span className="text-base sm:text-2xl italic leading-relaxed mb-2">{item.place}</span>
                </div>
                <div
                ...
                >
                  ...
                  <span className="text-base sm:text-2xl italic leading-relaxed mb-2">{item.time}</span>
                </div>
              </div>
              <br />
              ...
              {item.mapUrl && (
                <a
                  ...
                  className="italic leading-relaxed mb-2 mt-auto inline-flex items-center gap-2 px-5 py-2 rounded-full text-[12px] sm:text-xs font-medium tracking-wide transition-all duration-300 hover:scale-105"
                  style={{
