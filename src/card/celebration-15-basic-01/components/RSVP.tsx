...
export default function RSVP() {
  ...
  const { rsvp, paramsGeneral, webhookUrl, presents } = config;
  ...
  const handleClose = () => { setIsSubmitted(false); setFormData({ message: '', attendance: 'si' }); };
          ...
          {!isSubmitted && (
            ...
            >
              <motion.div
                ...
                className="w-full rounded-2xl md:rounded-3xl shadow-xl relative overflow-visible border"
                style={{
                  background: `linear-gradient(160deg, ${presents.backgroundColorFrom}, ${presents.backgroundColorVia}, ${presents.backgroundColorTo})`,
                  borderColor: presents.borderColorIconMoments,
                  borderWidth: '2px',
                }}
              >
                ...
                <motion.div
                  ...
                  className="absolute -top-10 left-1/2 w-20 h-20 rounded-full flex items-center justify-center shadow-xl z-20"
                  style={{
                ...
                >
                  {formData.attendance === 'si' ? (
                    <Smile className="w-10 h-10" style={{ color: presents.iconColor, opacity: 0.8 }} />
                  ) : (
                    <Frown className="w-10 h-10" style={{ color: presents.iconColor, opacity: 0.8 }} />
                  )}
                </motion.div>
                ...
                <div className="p-6 md:p-12 pt-14 md:pt-16 relative z-0 flex flex-col items-center">
                  ...
                  <label
                    className="text-2xl md:text-3xl italic font-bold mb-2"
                    style={{ fontFamily: rsvp.title3TextFont, color: presents.titleColor }}
                  >
                    <br />
                    <br />
                    {rsvp.title3TextMsg}
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6 w-full">
                      ...
                      <div className="flex flex-row gap-4 justify-center">
                        <button
                          ...
                          style={formData.attendance === 'si'
                            ? { background: 'linear-gradient(135deg, #7e657cff 0%, #ae95bdff 100%)', color: '#ffffff', borderColor: '#765e72ff', transform: 'scale(1.05)' }
                    ...
                    <div>
                      <br />
                      <label
                        className="text-base sm:text-2xl italic leading-relaxed mb-2 flex items-center justify-center"
                        style={{ fontFamily: rsvp.msgTextFont, color: presents.textColor }}
                      >
                        Deja tu mensaje
                      </label>
                      <div className="relative">
                        ...
                        <textarea
                          ...
                          rows={5}
                          placeholder="Escribe tu mensaje para la cumpleañera.."
                    ...
                    <div className="pt-8 flex justify-center">
                      <motion.button
                        ...
                        style={{
                          background: 'linear-gradient(45deg, #7e657cff  0%, #ae95bdff  45%, #d9b7e4ff 50%, #d9b7e4ff 55%, #7e657cff 100%)',
