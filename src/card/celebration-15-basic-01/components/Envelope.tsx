...
import mirrorImg from '../img/marco7.png';
import marcoImg from '../img/marco6.png';
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            ...
            >
              <div className="w-[90%] h-[100%] relative overflow-hidden flex items-center justify-center">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center text-center p-4">
                  ...
                  <p
                    className="text-[9px] md:text-[10px] tracking-[0.25em] uppercase mb-2 font-bold"
                    style={{ color: envelope.textColor || '#8B6914', fontFamily: 'var(--v-font-utility)', opacity: 0.8 }}
                  >
                    {envelope.cardMessageforguestsText}
                  </p>
                  <p
                    className="text-base md:text-xl italic font-bold leading-tight mb-3 "
            ...
            >
              <div className="w-full h-full relative overflow-hidden flex items-center justify-center">
                ...
                <div className="absolute w-[68%] h-[67%] top-[22%] overflow-hidden flex items-center justify-center z-10">
                ...
                <img
                  src={mirrorImg}
                  alt="Espejo"
                  className="absolute inset-0 w-full h-full object-contain pointer-events-none drop-shadow-md z-20"
                />
              </div>
            </motion.div>
          </div>
