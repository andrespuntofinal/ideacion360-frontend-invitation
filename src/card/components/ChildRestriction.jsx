        ...
        <section className="w-full h-full flex flex-col py-0 -mt-6 md:mt-0">
            <div className="w-full mx-auto flex-1 flex flex-col">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
                    ...
                    style={{
                        background: `linear-gradient(to bottom right, ${childRestriction.backgroundColorFrom}, ${childRestriction.backgroundColorVia}, ${childRestriction.backgroundColorTo})`,
                    ...
                    <div className="w-16 h-16 md:w-24 md:h-24 rounded-full flex items-center justify-center mb-6 md:mb-8"
                        style={{ background: childRestriction.backgroundColorIconMoments, border: `3px solid ${childRestriction.borderColorIconMoments}` }}>
                        <Users className="w-8 h-8 md:w-12 md:h-12" style={{ color: childRestriction.iconColor }} />
                    </div>
