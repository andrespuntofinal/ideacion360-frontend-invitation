...
import '../vintage.css';
import calendarImg from '../img/calendar-v4.png';
import calendarCoupleImg from '../img/calendar-v2.png';
          ...
          {dateImg && (
            <div className="flex-1 min-w-0 flex justify-center">
              ...
              >
                ...
                <div className="absolute w-[78%] h-[68%] top-[16%] left-[11%] rounded-full overflow-hidden flex items-center justify-center z-0">
                  <img
                    src={dateImg}
                    alt="Save the date"
          ...
          <div className="flex-1 min-w-0 flex justify-center">
            ...
            >
              ...
              <div className="absolute inset-0 z-20 flex flex-col items-center justify-center pt-[15%] pb-[10%] px-[12%]">
                ...
                {/* Year with "de" */}
                <span
                  className="text-xs sm:text-lg md:text-xl italic"
                  style={{
                    color: '#8B6914',
                    fontFamily: 'var(--v-font-display)',
                    lineHeight: '1.2',
