...
import {
  LayoutDashboard, Calendar, LogOut, Menu, X, Zap,
...
const AdminLayout = ({ children }) => {
  ...
  const handleLogout = () => {
    logout();
    navigate('/Wedding-Invitation/Admin');
  };
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <nav style={{ flex: 1, padding: '1rem', overflowY: 'auto' }}>
        <div style={{ marginBottom: '0.5rem' }}>
          <p style={{ color: 'var(--text-muted)', fontSize: '0.65rem', textTransform: 'uppercase', letterSpacing: '0.1em', padding: '0 0.75rem', marginBottom: '0.5rem' }}>
            Menú Principal
          </p>
              ...
              <Link key={href} to={href} style={{ textDecoration: 'none' }} onClick={() => setSidebarOpen(false)}>
                ...
                >
                  ...
                  <span style={{
                    ...
                    color: active ? 'var(--color-purple-light)' : 'var(--text-secondary)',
                  }}>
                    {label}
                  </span>
      ...
      <div style={{ padding: '1rem', borderTop: '1px solid var(--border-glass)' }}>
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ color: 'var(--text-primary)', fontWeight: 600, fontSize: '0.85rem', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
          ...
          <>
            ...
            <motion.aside
              ...
              style={{
                ...
                background: 'var(--bg-card)', borderRight: '1px solid var(--border-glass)',
                zIndex: 101,
              }}
            >
              <SidebarContent />
